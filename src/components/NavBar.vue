...
<nav
    ...
    >
      ...
      >
        ...
        <li class="menu-button"><a href="#work" v-smooth-scroll>Trabajos</a></li>
        <li class="menu-button">
          <a href="#testimonial" v-smooth-scroll>Tecnologías</a>
        </li>
        <li class="menu-button"><a href="#about" v-smooth-scroll>Contacto</a></li>
      </ul>
    </nav>
    </template>
    <script>
